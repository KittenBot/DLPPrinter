#!/usr/bin/python3
# -*- coding: utf-8 -*-
# Created by: python.exe -m py2exe DIMain.py -W setup.py
...
DIMain = Target(
    ...
    script="DIMain.py", # path of the main script

    # Allows to specify the basename of the executable, if different from 'DIMain'
    # dest_base = "DIMain",

    # Icon resources:[(resource_id, path to .ico file), ...]
    # icon_resources=[(1, r"DIMain.ico")]

    other_resources = [(RT_MANIFEST, 1, (manifest_template % dict(prog="DIMain", level="asInvoker")).encode("utf-8")),
